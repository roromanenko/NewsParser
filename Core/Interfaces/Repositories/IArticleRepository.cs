...
public interface IArticleRepository
{
	...
	Task<List<Article>> GetAnalysisDoneAsync(Guid projectId, int page, int pageSize, string? search, string sortBy, CancellationToken cancellationToken = default);
	Task<int> CountAnalysisDoneAsync(Guid projectId, string? search, CancellationToken cancellationToken = default);
