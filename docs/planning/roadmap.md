...
- [ ] **Step 10 — Event Publishing** Use Event as Publication source item instead of Article since Event includes >= 1 article and it is more siutable for review and publication content generation.
