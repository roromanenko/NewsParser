...
------------ | ------------- | ------------- | -------------
**items** | [**Array&lt;EventListItemDto&gt;**](EventListItemDto.md) |  | [optional] [default to undefined]
...
```typescript
import { EventListItemDtoPagedResult } from './api';

const instance: EventListItemDtoPagedResult = {
    items,
    page,
    pageSize,
    totalCount,
